...
<html lang="fr">
    <head>
        ...
        <title>Canhumanitaire | Erreur 401</title>
        <meta charset="utf-8">
        <link rel="icon" type="image/png" href="images/logo.png" />
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

        <META NAME="TITLE" CONTENT="Canhumanitaire | Erreur 401">
        <META NAME="AUTHOR" CONTENT="Matthieu Devilliers">
        <META NAME="DESCRIPTION" CONTENT="Page Erreur 401">
                    ...
                    <div class="container">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-md-10 text-center">
                                <h2 class="heading">Erreur 401</h2>
